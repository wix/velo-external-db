...
export const createRouter = () => {
    ...
    router.post('count', async(req, res, next) => {
        const countRequest: CountRequest = req.body;
    ...
    router.post('aggregate', async(req, res, next) => {
        const aggregateRequest: AggregateRequest = req.body;
    ...
    router.post('insert', async(req, res, next) => {
        // todo: handle upserts.
        try {
            const insertRequest: InsertRequest = req.body;
    ...
    router.post('remove', async(req, res, next) => {
        try {
            const removeRequest: RemoveRequest = req.body;

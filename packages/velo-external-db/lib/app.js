...
const { DataService, SchemaService, OperationService, CacheableSchemaInformation, FilterTransformer, AggregationTransformer  } = require('velo-external-db-core')
...
const load = async() => {
    ...
    const dataService = new DataService(dataProvider, schemaInformation, filterTransformer, aggregationTransformer)

...
const { DataService, SchemaService, OperationService, CacheableSchemaInformation, FilterTransformer, AggregationTransformer, QueryValidator, SchemaAwareDataService, ItemPatcher } = require('velo-external-db-core')
...
const load = async() => {
    ...
    const itemPatcher = new ItemPatcher()
    const schemaAwareDataService = new SchemaAwareDataService(dataService, queryValidator, schemaInformation, itemPatcher)

...
describe(`Check Pool Connection: ${currentDbImplementationName()}`, () => {
    ...
    if (shouldRunOnlyOn(['MySql', 'Postgres', 'Spanner', 'Firestore'], currentDbImplementationName())) {
    ...
    if (shouldNotRunOn(['MySql', 'Postgres', 'Spanner', 'Firestore'], currentDbImplementationName())) {

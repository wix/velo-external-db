const { SchemaProvider, schemaSupportedOperations } = require('./mssql_schema_provider')
...
module.exports = { SchemaProvider, DataProvider, FilterParser, SchemaColumnTranslator, driver, init, opsDriver, DatabaseOperations, schemaSupportedOperations }
